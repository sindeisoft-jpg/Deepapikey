...
class SimpleFixedDeepSeekBrowser(QMainWindow):
    """简化修复版主窗口类"""
    ...
    def init_ui(self):
        """初始化用户界面"""
        self.setWindowTitle("DeepSeek Qt浏览器 - 简化修复版")
...
def main():
    ...
    app.setApplicationName("DeepSeek Qt浏览器 - 简化修复版")
    ...
    window = SimpleFixedDeepSeekBrowser()
    window.show()
